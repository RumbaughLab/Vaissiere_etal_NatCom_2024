...
# copy files ####
dir.create('Z:/Vaissiere/00-ephys temp/MATLA/Dec/15')

file.copy(from=list.files('C:/Users/invivo-ephys/Documents/MATLA/2017/Dec/15', full.names = TRUE), 
          to='Z:/Vaissiere/00-ephys temp/MATLA/Dec/15', 
          overwrite = TRUE) 
