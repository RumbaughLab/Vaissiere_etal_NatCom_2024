...
# copy files ####
dir.create('X:/Vaissiere/00-ephys temp/MATLA/Dec/07')

file.copy(from=list.files('C:/Users/invivo-ephys/Documents/MATLA/2017/Dec/07', full.names = TRUE), 
          to='X:/Vaissiere/00-ephys temp/MATLA/Dec/07', 
          overwrite = TRUE) 
...
# data light
obtainDataFromGroup(c(61), baselineTrace = 200) 

# graph light
for (i in c(61)){graphSummaryTPS(i)}
